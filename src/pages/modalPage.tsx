            ...
            <div className="bg-white/70 border-pink-200 border-2 rounded-xl relative overflow-hidden transition-all">
              ...
              {openIndex === 1 && (
                <div className="px-4 pb-4 border-t border-pink-100 pt-3">
                  ...
                  {/* 복사하기 테스트용 버튼이 기존에 필요하셨다면 여기에 배치 가능합니다 */}
                  <button onClick={handleCopy} className="w-full mt-3 bg-pink-500 text-white p-2 rounded-xl font-bold text-xs shadow-sm hover:bg-pink-600 transition-colors">
                    📋 주문 내용 복사하기
                  </button>
                </div>
              )}
                ...
                <div className="px-4 pb-4 border-t border-pink-100 pt-3">
                  <div className="text-xs text-gray-700 font-medium bg-pink-50 p-3 rounded-lg border border-pink-100 flex flex-col gap-1.5">
                    <p>
                      ...
                      <strong className="text-pink-500">총 4분께 록시땅 핸드크림</strong>을 선물로 드립니다!
                      <br />
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-pink-500 text-sm font-bold hover:text-pink-600 transition-colors mt-3"
                    target="_blank"
